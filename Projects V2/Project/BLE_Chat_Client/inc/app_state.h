...
/* Exported macros -----------------------------------------------------------*/
#define APP_FLAG(flag) (app_flags & flag)       //Checks if the flag is set

#define APP_FLAG_SET(flag) (app_flags |= flag)  //Sets a flag
#define APP_FLAG_CLEAR(flag) (app_flags &= ~flag)       //Clears the flag
