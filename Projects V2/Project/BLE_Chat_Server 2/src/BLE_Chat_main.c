...
int main(void)
{
...
#else
        uint8_t bdaddr[] = {0xcc, 0x00, 0x00, 0xE1, 0x80, 0x02};
#endif
    ...
    
    {
        ...
        const char *name = "BlueNRG2";  
              ret = aci_gatt_update_char_value(service_handle, dev_name_char_handle, 0, 8, (uint8_t *)name);        
              if(ret){
...
{  
    ...
    const char local_name[] = {AD_TYPE_COMPLETE_LOCAL_NAME,'B','l','u','e','N','R','G','_','C','h','a','t','2'};
