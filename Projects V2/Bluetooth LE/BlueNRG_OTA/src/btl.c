...
uint8_t currentImageInfos[8] = {0x08,0x00,0x62,0x00,0x08,0x01,0xFF,0xFF};
...
uint8_t currentImageInfos[8] = {0x08,0x00,0x38,0x00,0x08,0x00,0xE0,0x00}; 
...
uint8_t currentImageInfos[8] = {0x08,0x00,0xE0,0x00,0x08,0x01,0xFF,0xFF};
#endif
...
tBleStatus Add_Btl_Service(void)
{
    ...
    ret =  aci_gatt_add_char(btlServHandle, UUID_TYPE_128, uuid, 8, CHAR_PROP_READ, ATTR_PERMISSION_NONE, GATT_NOTIFY_READ_REQ_AND_WAIT_FOR_APPL_RESP,
    ...
    ret =  aci_gatt_add_char(btlServHandle, UUID_TYPE_128, uuid, 9, CHAR_PROP_READ|CHAR_PROP_WRITE|CHAR_PROP_WRITE_WITHOUT_RESP, ATTR_PERMISSION_NONE, GATT_NOTIFY_READ_REQ_AND_WAIT_FOR_APPL_RESP | GATT_NOTIFY_ATTRIBUTE_WRITE,
    ...
    ret =  aci_gatt_add_char(btlServHandle, UUID_TYPE_128, uuid, 20, CHAR_PROP_READ|CHAR_PROP_WRITE|CHAR_PROP_WRITE_WITHOUT_RESP, ATTR_PERMISSION_NONE, GATT_NOTIFY_READ_REQ_AND_WAIT_FOR_APPL_RESP | GATT_NOTIFY_ATTRIBUTE_WRITE,
    ...
    ret =  aci_gatt_add_char(btlServHandle, UUID_TYPE_128, uuid, 4, CHAR_PROP_NOTIFY|CHAR_PROP_READ, ATTR_PERMISSION_NONE, GATT_NOTIFY_READ_REQ_AND_WAIT_FOR_APPL_RESP,
