...
#define GAP_START_GENERAL_CONN_ESTABLISH_PROC_CP_SIZE 14
...
typedef __packed struct _gap_start_selective_conn_establish_proc_cp{
  ...
  uint8_t addr_array[HCI_MAX_PACKET_SIZE-GAP_START_SELECTIVE_CONN_ESTABLISH_PROC_CP_SIZE];
...
typedef __packed struct _gatt_read_multiple_charac_val_cp{
  uint16_t conn_handle;
  uint8_t num_handles;
  uint8_t  set_of_handles[HCI_MAX_PACKET_SIZE-GATT_READ_MULTIPLE_CHARAC_VAL_CP_SIZE];
...
typedef __packed struct _gatt_write_long_charac_val_cp{
  ...
  uint16_t val_offset;
  uint8_t  val_len;
  uint8_t  attr_val[HCI_MAX_PACKET_SIZE-GATT_WRITE_LONG_CHARAC_VAL_CP_SIZE];
...
typedef __packed struct _gatt_write_charac_reliable_cp{
  ...
  uint16_t val_offset;
  uint8_t  val_len;
  uint8_t  attr_val[HCI_MAX_PACKET_SIZE-GATT_WRITE_CHARAC_RELIABLE_CP_SIZE];
...
typedef __packed struct _gatt_write_long_charac_desc_cp{
  ...
  uint16_t val_offset;
  uint8_t  val_len;
  uint8_t  attr_val[HCI_MAX_PACKET_SIZE-GATT_WRITE_LONG_CHARAC_DESC_CP_SIZE];
