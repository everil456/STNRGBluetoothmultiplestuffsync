...
/**
  ...
  *         @endcode
  * @param       role     One of the allowed roles: @ref GAP_PERIPHERAL_ROLE or @ref GAP_CENTRAL_ROLE.
 ...
 * 					 0x0004 to 0x4000. This corresponds to a time range 2.5 msec to 10240 msec.
 * 					 For a number N, Time = N x 0.625 msec.
 * @param own_address_type Type of our address used during active scanning (@ref PUBLIC_ADDR, @ref RANDOM_ADDR).
...
typedef __packed struct _evt_gap_device_found{
	...
	uint8_t		data_length;  /**< Lenght of advertising or scan response data. */
 ...
 * as its own address as well as the peer address to which it wants to connect. See @ref _evt_gap_reconnection_addr.
 */
